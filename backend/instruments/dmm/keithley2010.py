"""Keithley 2010 Digital Multimeter driver."""

from ..base import Capability
from .base_dmm import DMMBase


class Keithley2010(DMMBase):
    """Keithley 2010 – superset of Keithley 2000 with dBm and ratio functions."""
    ...
    RANGE_SCPI = {
        ...
        "100V":  "100",  "1000V": "1E3",
        "10mA":  "0.01", "100mA": "0.1","1A": "1",
        "100Ω":  "100",  "1kΩ": "1E3", "10kΩ": "1E4",
        "100kΩ": "1E5",  "1MΩ": "1E6", "10MΩ": "1E7",
        "100MΩ": "1E8",  "1GΩ": "1E9",
    }
